...
import (
	...
	"github.com/hyoungsungkim/nameservice/x/nameservice/client/cli"
	"github.com/hyoungsungkim/nameservice/x/nameservice/client/rest"
...
func (AppModuleBasic) RegisterRESTRoutes(ctx context.CLIContext, rtr *mux.Router) {
	rest.RegisterRoute(ctx, rtr, StoreKey)
}
