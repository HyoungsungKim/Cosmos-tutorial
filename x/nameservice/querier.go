...
func queryResolve(ctx sdk.Context, pat []string, req abci.RequestQuery, keeper Keeper)([]byte, sdk.Error) {
	...
	res, err := codec.MarshalJSONIndent(keeper.cdc, QueryResolve{value})
	if err != nil {
...
func queryNames(ctx sdk.Context, req abci.RequestQuery, keeper Keeper) ([]byte, sdk.Error) {
	...
	for ; iterator.Vaild(); iterator.Next() {
